...
import org.hello.processors.GetFileMessageProcessor;
    ...
    implements BeanDefinitionParser
{
    ...
    public GetFileDefinitionParser() {
        patternInfo = TemplateParser.createMuleStyleParser().getStyle();
    }

    public BeanDefinition parse(Element element, ParserContext parserContent) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(GetFileMessageProcessor.class.getName());

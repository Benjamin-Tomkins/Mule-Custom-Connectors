...
import com.kss.sms.processors.SendMessageMessageProcessor;
    ...
    implements BeanDefinitionParser
{
    ...
    public SendMessageDefinitionParser() {
        patternInfo = TemplateParser.createMuleStyleParser().getStyle();
    }

    public BeanDefinition parse(Element element, ParserContext parserContent) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(SendMessageMessageProcessor.class.getName());
        ...
        if ((element.getAttribute("no")!= null)&&(!StringUtils.isBlank(element.getAttribute("no")))) {
            builder.addPropertyValue("no", element.getAttribute("no"));
        }

...
/**
 * A <code>BulkSMSConnectorLifecycleAdapter</code> is a wrapper around {@link BulkSMSConnector } that adds lifecycle methods to the pojo.
 * 
 */
public class BulkSMSConnectorLifecycleAdapter
    extends BulkSMSConnectorCapabilitiesAdapter
    implements Disposable, Initialisable, Startable, Stoppable
{
    ...
    public void initialise() {
        Logger log = LoggerFactory.getLogger(BulkSMSConnectorLifecycleAdapter.class);

...
/**
 * A <code>QRCodeConnectorLifecycleAdapter</code> is a wrapper around {@link QRCodeConnector } that adds lifecycle methods to the pojo.
 * 
 */
public class QRCodeConnectorLifecycleAdapter
    extends QRCodeConnectorCapabilitiesAdapter
    implements Disposable, Initialisable, Startable, Stoppable
{
    ...
    public void initialise() {
        Logger log = LoggerFactory.getLogger(QRCodeConnectorLifecycleAdapter.class);

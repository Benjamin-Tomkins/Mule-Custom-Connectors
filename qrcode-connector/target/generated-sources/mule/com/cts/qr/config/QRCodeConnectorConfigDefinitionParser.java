...
public class QRCodeConnectorConfigDefinitionParser
    implements BeanDefinitionParser
{
    ...
    public QRCodeConnectorConfigDefinitionParser() {
    ...
    public BeanDefinition parse(Element element, ParserContext parserContent) {
        ...
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(QRCodeConnectorConnectionManager.class.getName());
        if (Initialisable.class.isAssignableFrom(QRCodeConnectorConnectionManager.class)) {
            builder.setInitMethodName(Initialisable.PHASE_NAME);
        }
        if (Disposable.class.isAssignableFrom(QRCodeConnectorConnectionManager.class)) {

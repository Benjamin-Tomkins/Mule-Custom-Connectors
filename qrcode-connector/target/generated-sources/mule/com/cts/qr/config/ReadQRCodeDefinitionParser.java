...
import com.cts.qr.processors.ReadQRCodeMessageProcessor;
...
public class ReadQRCodeDefinitionParser
    implements BeanDefinitionParser
{
    ...
    public ReadQRCodeDefinitionParser() {
        patternInfo = TemplateParser.createMuleStyleParser().getStyle();
    }

    public BeanDefinition parse(Element element, ParserContext parserContent) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(ReadQRCodeMessageProcessor.class.getName());

...
import com.cts.qr.processors.CreateQRCodeMessageProcessor;
...
public class CreateQRCodeDefinitionParser
    implements BeanDefinitionParser
{
    ...
    public CreateQRCodeDefinitionParser() {
        patternInfo = TemplateParser.createMuleStyleParser().getStyle();
    }

    public BeanDefinition parse(Element element, ParserContext parserContent) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(CreateQRCodeMessageProcessor.class.getName());
        String configRef = element.getAttribute("config-ref");
        if ((configRef!= null)&&(!StringUtils.isBlank(configRef))) {
            builder.addPropertyValue("moduleObject", configRef);
        }
        if ((element.getAttribute("qrCodeData")!= null)&&(!StringUtils.isBlank(element.getAttribute("qrCodeData")))) {
            builder.addPropertyValue("qrCodeData", element.getAttribute("qrCodeData"));
        }

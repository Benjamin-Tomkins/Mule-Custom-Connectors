...
import com.cts.qr.processors.CreateBarCodeMessageProcessor;
...
public class CreateBarCodeDefinitionParser
    implements BeanDefinitionParser
{
    ...
    public CreateBarCodeDefinitionParser() {
        patternInfo = TemplateParser.createMuleStyleParser().getStyle();
    }

    public BeanDefinition parse(Element element, ParserContext parserContent) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(CreateBarCodeMessageProcessor.class.getName());
        String configRef = element.getAttribute("config-ref");
        if ((configRef!= null)&&(!StringUtils.isBlank(configRef))) {
            builder.addPropertyValue("moduleObject", configRef);
        }
        if ((element.getAttribute("BarCodeData")!= null)&&(!StringUtils.isBlank(element.getAttribute("BarCodeData")))) {
            builder.addPropertyValue("BarCodeData", element.getAttribute("BarCodeData"));
        }
        if ((element.getAttribute("filePath")!= null)&&(!StringUtils.isBlank(element.getAttribute("filePath")))) {
            builder.addPropertyValue("filePath", element.getAttribute("filePath"));
        }

...
import com.cts.qr.processors.ReadBarCodeMessageProcessor;
...
public class ReadBarCodeDefinitionParser
    implements BeanDefinitionParser
{
    ...
    public ReadBarCodeDefinitionParser() {
        patternInfo = TemplateParser.createMuleStyleParser().getStyle();
    }

    public BeanDefinition parse(Element element, ParserContext parserContent) {
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(ReadBarCodeMessageProcessor.class.getName());

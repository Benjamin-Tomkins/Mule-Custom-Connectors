...
/**
 * A <code>CouchDBConnectorLifecycleAdapter</code> is a wrapper around {@link CouchDBConnector } that adds lifecycle methods to the pojo.
 * 
 */
public class CouchDBConnectorLifecycleAdapter
    extends CouchDBConnectorCapabilitiesAdapter
    implements Disposable, Initialisable, Startable, Stoppable
{
    ...
    public void initialise() {
        Logger log = LoggerFactory.getLogger(CouchDBConnectorLifecycleAdapter.class);

...
public class CouchDBConnectorConfigDefinitionParser
    implements BeanDefinitionParser
{
    ...
    public CouchDBConnectorConfigDefinitionParser() {
    ...
    public BeanDefinition parse(Element element, ParserContext parserContent) {
        ...
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(CouchDBConnectorConnectionManager.class.getName());
        if (Initialisable.class.isAssignableFrom(CouchDBConnectorConnectionManager.class)) {
            builder.setInitMethodName(Initialisable.PHASE_NAME);
        }
        if (Disposable.class.isAssignableFrom(CouchDBConnectorConnectionManager.class)) {

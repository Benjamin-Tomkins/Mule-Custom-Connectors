...
/**
 * A <code>InstagramConnectorLifecycleAdapter</code> is a wrapper around {@link InstagramConnector } that adds lifecycle methods to the pojo.
 * 
 */
public class InstagramConnectorLifecycleAdapter
    ...
    implements Disposable, Initialisable, Startable, Stoppable
{
    ...
    public void initialise() {
        Logger log = LoggerFactory.getLogger(InstagramConnectorLifecycleAdapter.class);

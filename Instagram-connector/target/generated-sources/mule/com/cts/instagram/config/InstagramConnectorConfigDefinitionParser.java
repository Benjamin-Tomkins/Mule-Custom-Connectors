...
public class InstagramConnectorConfigDefinitionParser
    implements BeanDefinitionParser
{
    ...
    public InstagramConnectorConfigDefinitionParser() {
    ...
    public BeanDefinition parse(Element element, ParserContext parserContent) {
        ...
        BeanDefinitionBuilder builder = BeanDefinitionBuilder.rootBeanDefinition(InstagramConnectorConnectionManager.class.getName());
        if (Initialisable.class.isAssignableFrom(InstagramConnectorConnectionManager.class)) {
            builder.setInitMethodName(Initialisable.PHASE_NAME);
        }
        if (Disposable.class.isAssignableFrom(InstagramConnectorConnectionManager.class)) {

...
/**
 * SearchVenuesMessageProcessor invokes the {@link com.kss.social.FoursquareConnector#searchVenues(java.lang.String)} method in {@link FoursquareConnector }. For each argument there is a field in this processor to match it.  Before invoking the actual method the processor will evaluate and transform where possible to the expected argument type.
 * 
 */
    ...
    implements FlowConstructAware, MuleContextAware, Disposable, Initialisable, Startable, Stoppable, MessageProcessor
{
        ...
        throws MuleException
    {
        ...
        try {
            String _transformedContent = ((String) evaluateAndTransform(_muleMessage, SearchVenuesMessageProcessor.class.getDeclaredField("_contentType").getGenericType(), null, content));
            ...
            resultPayload = connection.searchVenues(_transformedContent);
